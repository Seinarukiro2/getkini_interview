...
async def create_email_message(event) -> None:
    """
    ...
    if eml_files:
        ...
        for eml_file in eml_files:
            ...
            callback_data = f"view_eml_{eml_file}"  # For example: 'view_eml_file1.eml'
            button = Button.inline(eml_file[:-4], data=callback_data)  # Remove '.eml' extension 
